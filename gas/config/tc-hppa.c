	  ...
	  switch (*args)
	      ...
	      if (*s == ',')
		{
		  ...
		  *s = c;
	      ...
	      /* Only encode the "doubleword" bit for "cmpclr" instructions.  */
	      if ((opcode & 0xfc000fc0) == 0x08000880)
		opcode |= doubleword << 5;
	      else if ((opcode & 0xfc000000) == 0x90000000)
		opcode |= doubleword << 11;
	      opcode |= cmpltr << 13;
	      ...
	      if (*s == ',')
		{
		  ...
		  *s = c;
	      ...
	      /* Only encode the "doubleword" bit for "add" instructions.  */
	      if ((opcode & 0xfc0002c0) == 0x08000200)
		opcode |= doubleword << 5;
	      opcode |= cmpltr << 13;
	      INSERT_FIELD_AND_CONTINUE (opcode, flag, 12);
	    ...
	    /* Completers for "add" instruction.  */
	    case '#':
	      doubleword = 0;
	      if (*s == ',')
		{
		  ...
		  *s = 0x00;
		  ...
		  if (strcmp (name, "c") == 0 || strcmp (name, "dc") == 0)
		    {
		      doubleword = ! strcmp (name, "dc");
		      e1 = 1, e2 = 1, *s = c;
		  ...
		  opcode |= doubleword << 5;
		  opcode |= e2 << 8;
		  INSERT_FIELD_AND_CONTINUE (opcode, e1, 10);
		}
	      break;
	      ...
	      if (*s == ',')
		{
		  ...
		  *s = 0x00;
		  ...
		  INSERT_FIELD_AND_CONTINUE (opcode, e1, 11);
		}
	      break;
