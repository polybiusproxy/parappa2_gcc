...
/* Open a cpu descriptor table for use.
   MACH_ is one of enum mach_attr.
   ISA_ is one of enum isa_attr.  */

extern CGEN_CPU_DESC CGEN_SYM (cpu_open) PARAMS ((int mach_, int isa_,
...
extern void cgen_set_cpu PARAMS ((CGEN_CPU_DESC, int mach_, int isa_,
				  enum cgen_endian));
