...
#if defined (TARGET_IS_elf32l5900) || defined (TARGET_IS_elf32elmip)
  secname = bfd_get_section_name (s->owner, s);
/* ??? from elf/mips.h which we probably shouldn't include */
#define SHNAME_DVP_OVERLAY_PREFIX ".DVP.overlay."
  if (strncmp (secname, SHNAME_DVP_OVERLAY_PREFIX,
