...
/* CYGNUS LOCAL nickc/inhibit_libc */
#if defined L_bb_init_func && defined inhibit_libc

	/* If inhibit_libc is defined then the libgcc2 function
	   __bb_init_func will not be created.  This will then cause
	   a linkage failure if the -fprofile-arc command line option
	   is used.  Hence we provide a dummy option here.  */
	
	.globl	SYM (__bb_init_func)
	TYPE	(__bb_init_func)
	.align 0
SYM (__bb_init_func):
	RET	pc, lr
