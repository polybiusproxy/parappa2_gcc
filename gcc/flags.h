...
/*  Nonzero if we use morgan's edge based LCM for gcse.  */

extern int flag_edge_lcm;

/*  Nonzero if we use morgan's edge based LCM for gcse, and we also want 
    to perform enhanced load motion.  */

extern int flag_edge_lm;

/*  Nonzero if we use morgan's edge based LCM for gcse, and we also want 
    to perform store motion.  */

extern int flag_edge_sm;
