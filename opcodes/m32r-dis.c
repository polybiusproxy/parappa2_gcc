 ...
 disassemble_info *info = (disassemble_info *) xinfo;
  ...
  switch (opindex)
    ...
    case M32R_OPERAND_HASH :
      print_hash (cd, info, fields->f_nil, 0|(1<<(CGEN_OPERAND_SIGNED-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_HI16 :
      print_normal (cd, info, fields->f_hi16, 0|(1<<(CGEN_OPERAND_SIGN_OPT-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_IMM1 :
      print_normal (cd, info, fields->f_imm1, 0|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_SCR :
      print_keyword (cd, info, & m32r_cgen_opval_cr_names, fields->f_r2, 0);
      break;
    case M32R_OPERAND_SIMM16 :
      print_normal (cd, info, fields->f_simm16, 0|(1<<(CGEN_OPERAND_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_SIMM8 :
      print_normal (cd, info, fields->f_simm8, 0|(1<<(CGEN_OPERAND_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_SLO16 :
      print_normal (cd, info, fields->f_simm16, 0|(1<<(CGEN_OPERAND_SIGNED-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    ...
    case M32R_OPERAND_UIMM16 :
      print_normal (cd, info, fields->f_uimm16, 0|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_UIMM24 :
      print_address (cd, info, fields->f_uimm24, 0|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_OPERAND_RELOC-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_OPERAND_ABS_ADDR-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_UIMM4 :
      print_normal (cd, info, fields->f_uimm4, 0|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
    case M32R_OPERAND_UIMM5 :
      print_normal (cd, info, fields->f_uimm5, 0|(1<<(CGEN_OPERAND_HASH_PREFIX-CGEN_ATTR_BOOL_OFFSET)), pc, length);
      break;
     ...
     disassemble_info *info;
{
  ...
  if (! cd)
    {
      cd = m32r_cgen_cpu_open (mach, isa,
				 big_p ?
				 CGEN_ENDIAN_BIG
				 : CGEN_ENDIAN_LITTLE);
      m32r_cgen_init_dis (cd);
