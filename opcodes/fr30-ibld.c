    ...
    case FR30_OPERAND_DISP10 :
      {
        ...
        value = ((int) (value) >> (2));
        errmsg = insert_normal (cd, value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 4, 8, 16, total_length, buffer);
      }
      break;
    case FR30_OPERAND_DISP8 :
      errmsg = insert_normal (cd, fields->f_disp8, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 4, 8, 16, total_length, buffer);
      break;
...
do {
  ...
  FLD (f_i20_16) = ((FLD (f_i20)) & (65535));
    ...
    case FR30_OPERAND_I32 :
      errmsg = insert_normal (cd, fields->f_i32, 0|(1<<(CGEN_IFLD_SIGN_OPT-CGEN_ATTR_BOOL_OFFSET)), 16, 0, 32, 32, total_length, buffer);
      break;
    ...
    case FR30_OPERAND_LABEL12 :
      {
        ...
        errmsg = insert_normal (cd, value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_IFLD_PCREL_ADDR-CGEN_ATTR_BOOL_OFFSET)), 0, 5, 11, 16, total_length, buffer);
      }
      break;
    case FR30_OPERAND_LABEL9 :
      {
        ...
        value = ((int) (((value) - (((pc) + (2))))) >> (1));
        errmsg = insert_normal (cd, value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_IFLD_PCREL_ADDR-CGEN_ATTR_BOOL_OFFSET)), 0, 8, 8, 16, total_length, buffer);
      }
      break;
    ...
    case FR30_OPERAND_S10 :
      {
        ...
        value = ((int) (value) >> (2));
        errmsg = insert_normal (cd, value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 8, 8, 16, total_length, buffer);
      }
      break;
     ...
     bfd_vma pc;
{
  ...
  switch (opindex)
    ...
    case FR30_OPERAND_DISP10 :
      {
        long value;
        length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 4, 8, 16, total_length, pc, & value);
        value = ((value) << (2));
        fields->f_disp10 = value;
      }
      break;
    case FR30_OPERAND_DISP8 :
      length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 4, 8, 16, total_length, pc, & fields->f_disp8);
      break;
    case FR30_OPERAND_DISP9 :
      {
        long value;
...
do {
  FLD (f_i20) = ((((FLD (f_i20_4)) << (16))) | (FLD (f_i20_16)));
      ...
      break;
    case FR30_OPERAND_I32 :
      length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGN_OPT-CGEN_ATTR_BOOL_OFFSET)), 16, 0, 32, 32, total_length, pc, & fields->f_i32);
      break;
    case FR30_OPERAND_I8 :
    ...
    case FR30_OPERAND_LABEL12 :
      {
        long value;
        length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_IFLD_PCREL_ADDR-CGEN_ATTR_BOOL_OFFSET)), 0, 5, 11, 16, total_length, pc, & value);
        value = ((((value) << (1))) + (((pc) + (2))));
    ...
    case FR30_OPERAND_LABEL9 :
      {
        long value;
        length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET))|(1<<(CGEN_IFLD_PCREL_ADDR-CGEN_ATTR_BOOL_OFFSET)), 0, 8, 8, 16, total_length, pc, & value);
        value = ((((value) << (1))) + (((pc) + (2))));
        fields->f_rel9 = value;
      }
      break;
    ...
    case FR30_OPERAND_S10 :
      {
        long value;
        length = extract_normal (cd, ex_info, insn_value, 0|(1<<(CGEN_IFLD_SIGNED-CGEN_ATTR_BOOL_OFFSET)), 0, 8, 8, 16, total_length, pc, & value);
        value = ((value) << (2));
        fields->f_s10 = value;
      }
      break;
