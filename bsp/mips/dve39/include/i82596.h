 ...
 */
#define I596_ADDR(p) (void *)((((int)(p)&0xffff)<<16) | \
			      (((int)(p) >> 16)&0x1fff))

/*
 * Convert int to i586 32-bit word.
 */
#define I596_WORD(p) ((((p)&0xffff)<<16) | (((p) >> 16)&0xffff))

/*
 * Convert a cpu pointer to an uncached pointer.
 */
#define CPU_UNCACHED(p) ((void *)((unsigned)(p) | 0xa0000000))

/*
 * Convert an i596 pointer to an uncached cpu pointer.
 */
#define I596_CPU_UNCACHED(p) \
     (void *)(((((int)(p))>>16) & 0xffff) | ((((int)(p)) | 0xa000)<<16))
...
{                                                             \
    I596_BASE->port_lsw = ((unsigned short)((int)(p) & 0xfff0)) | 2; \
    __wbflush();                                              \
    I596_BASE->port_msw = (unsigned short)(((int)(p))>>16) & 0x1fff; \
    __wbflush();                                              \
}
