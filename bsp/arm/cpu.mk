#
# arm/cpu.mk -- Makefile fragment for ARM family.
#
...
CPU_HEADERS=@top_srcdir@/@archdir@/include/bsp/cpu.h @top_srcdir@/@archdir@/include/bsp/lh77790a.h
...
#
# Dependencies for common ARM objects.
#
...
gdb-cpu.o: gdb-cpu.c gdb.h gdb-cpu.h bsp/cpu.h bsp/bsp.h bsp_if.h insn.h $(ALL_DEPENDS)
irq-cpu.o: irq-cpu.c bsp/cpu.h bsp/bsp.h bsp_if.h gdb.h gdb-cpu.h insn.h $(ALL_DEPENDS)
singlestep.o: singlestep.c gdb.h gdb-cpu.h bsp/cpu.h bsp/bsp.h bsp_if.h insn.h $(ALL_DEPENDS)
