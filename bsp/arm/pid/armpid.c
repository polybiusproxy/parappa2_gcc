/*
 * armpid.c -- Support for ARM Pid Eval Board
 *
...
#if defined(HAVE_NET)
#error HAVE_NET Not Supported on ARMPid
#endif
...
/*
 * Dispatch code for Armpid interrupts. Called by exception dispatch code.
 */
static int
...
/*
 *  Initialize Armpid interrupt controller.
 */
static void
...
{
    { (void *)0x00000000, (void *)0x00000000, 0, 0x00002000, BSP_MEM_RAM },
    { (void *)0x00002000, (void *)0x00002000, 0, 0x0007E000, BSP_MEM_RAM },
    { (void *)0x00080000, (void *)0x00080000, 0, 0x00F80000, BSP_MEM_RAM },
    { (void *)0x04000000, (void *)0x04000000, 0, 0x04000000, BSP_MEM_ROM },
};
...
uart_irq_handler(int irq_nr, void *regs)
{
    ...
    if ((intstatus == ARMPID_SER_INT_SRC_RXRDY) ||
        (intstatus == ARMPID_SER_INT_SRC_RX_TIMEOUT))
    {
        ch = (*UART_RX_HOLDING(uart_dbg_base)) & 0xFFFF;
