...
#include <bsp/bsp.h>
#include <bsp/cpu.h>
#include <bsp/328ads.h>
#include "bsp_if.h"
#include "queue.h"
#include "gdb.h"

#if defined(HAVE_NET)
#error HAVE_NET Not Supported on M68k
#endif
 ...
 */
#define UART_INDEX(base)                 (((base) == MC68681_MR1A) ? 0 : 1)
#define UART_BASE_VALID(base)            (((base) == MC68681_MR1A) || ((base) == MC68681_MR1B))
...
{
    { (void *)0x0,      (void *)0x0,      0, 0x200000, BSP_MEM_RAM },
    { (void *)0x400000, (void *)0x400000, 0, 0x100000, BSP_MEM_ROM }
};
...
uart_irq_handler(int irq_nr, void *regs)
{
    ...
    if ((uart_dbg_base == MC68681_MR1A) &&
        ((MC68681_SR_RXRDY & *UART_STATUS_REGISTER(MC68681_MR1A)) != 0)) {
        /*
         * Expected interrupt on Port 0
         */
        port = MC68681_MR1A;
        return_code = 1;
    } else if ((uart_dbg_base == MC68681_MR1B) &&
               ((MC68681_SR_RXRDY & *UART_STATUS_REGISTER(MC68681_MR1B)) != 0)) {
        /*
...
_bsp_init_board_comm(void)
{
    ...
    init_uart((void *)MC68681_MR1A, 38400);
    init_uart((void *)MC68681_MR1B, 38400);
}
