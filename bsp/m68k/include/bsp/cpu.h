...
enum __regnames {
    ...
    REG_A0, REG_A1, REG_A2, REG_A3, REG_A4, REG_A5, REG_A6, REG_A7, REG_SP=REG_A7,
    REG_SR, REG_PC, REG_MAX=REG_PC
};
...
#endif /* __IMMEDIATE_PREFIX__ */

/* use the right prefix for registers.  */
#define REG(x) GLUE(__REGISTER_PREFIX__,x)

/* use the right prefix for immediate values.  */
#define IMM(x) GLUE(__IMMEDIATE_PREFIX__,x)
...
#define __cli()      asm volatile("         oriw   #0x0700,%sr")
#define __sti()      asm volatile("         andiw  #~0x0700,%sr")
